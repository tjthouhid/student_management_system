...
class Mod_course extends CI_Model {
    ...
    /**
       ...
       * @version 2017-11-26
       */
       function get_course_list_datatable(array $params)
       {
           ...
           $this->db->select('SQL_CALC_FOUND_ROWS cs.course_id, cs.course_id, cs.course_name,cs.course_price', false);
           $this->db->from('courses cs'); 
           ...
           return array(
               ...
               'recordsTotal' =>$this->get_total_records("courses","course_id"),
           );
       }
       /**
         ...
         * @version 2017-11-26
         */
      function save_course_info($postedData){
          
          $query= $this->db->insert("courses",$postedData);
         if($query){
          return true;  
         }else{
          return false;
