...
$(document).ready(function() {
    ...
    (function (){
            dataTableObj = $('#students_table').DataTable({ 
                ...
                "ajax": {
                    "url": site_url+"scadmin/students/index",
                    "type": "POST",
                ...
                "columnDefs": [
                    ...
                    {  "targets": [ 1 ], "orderable": true,  "name": "title", "className": "column-title", "visible": true },
                     {  "targets": [ 2 ], "orderable": true,  "name": "birthdate", "className": "column-name", "visible": true },
                     {  "targets": [ 3 ], "orderable": true,  "name": "gender", "className": "column-gender", "visible": true },
